...
import com.guge.myimagepicker.adapter.ImagePageAdapter;
import com.guge.myimagepicker.bean.ImageItem;
import com.guge.myimagepicker.util.Utils;
import com.guge.myimagepicker.view.ViewPagerFixed;
...
public abstract class ImagePreviewBaseActivity extends ImageBaseActivity {
    ...
    protected MyImagePicker imagePicker;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCurrentPosition = getIntent().getIntExtra(MyImagePicker.EXTRA_SELECTED_IMAGE_POSITION, 0);
        mImageItems = (ArrayList<ImageItem>) getIntent().getSerializableExtra(MyImagePicker.EXTRA_IMAGE_ITEMS);
