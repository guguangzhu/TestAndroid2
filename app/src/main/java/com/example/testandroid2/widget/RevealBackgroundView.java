...
//        revealAnimator.start();
        ...
        newAnimator=ValueAnimator.ofInt(0, getHeight());
        newAnimator.setInterpolator(INTERPOLATOR);
...
//                setScaleY((Float) animation.getAnimatedValue());
                setCurrentRadius((Integer) animation.getAnimatedValue());
            }
        });
...
//            canvas.drawRect(0,startLocationY-currentRadius/2,getWidth(),startLocationY+currentRadius/2,fillPaint);
        }
    }
