...
public class GridAdapter extends Adapter<GridAdapter.MyViewHolder> {
	...
	public GridAdapter(List<NewsBean.StoriesEntity> mDatas, Context context) {
		this.mDatas = mDatas;
	...
	public GridAdapter setOnItemClickLitener(OnItemClickLitener mOnItemClickLitener) {
